...
This is real `aiuse` output (synthetic demo accounts, generated by
[`docs/generate-readme-demo.py`](docs/generate-readme-demo.py) — no
screenshot). It's the exact priority ladder printed by plain `aiuse`, read
**bottom → top**: the pools most worth using right now sort to the bottom.
...
- [`docs/generate-readme-demo.py`](docs/generate-readme-demo.py) — regenerates the colored priority-ladder example at the top of this README from synthetic demo data (no real accounts, no screenshot).
