...
| QwenCloud          | native `qwencloud` (CLI, OAuth)                | Added 2026-08-22. CodexBar also ships a `qwen-cloud` provider (Chrome cookies) reporting the same canonical id; a potential cross-check peer, not required. See [`qwencloud-quota.md`](qwencloud-quota.md).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
