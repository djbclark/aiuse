...
**Date:** 2026-08-02 (originally 2026-07-30; refreshed after 3.0.4 and the
...
| -------------------- | ------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------- | ------------------------------- | ------------------------------------------------------------------------------------------------------ |
| **1**                | **Announce**                                                 | Best unpaid feedback channel; product ready enough                                                                | Low (0.5–2h, **operator only**) | [#10](https://github.com/djbclark/aiuse/issues/10) (refreshed to 3.0.4, ready to post)                 |
| **2**                | **Let hourly LaunchAgent run**                               | History learning needs dense snapshots                                                                            | None (already installed)        | Site `com.djbclark.aiuse`                                                                              |
| **3**                | **Source expansion (real, unblocked, not optional polish)**  | DeepSeek still has one live source; OpenRouter #17 resolved; #18 (Groq) closed 2026-08-02, confirmed resolved upstream    | Medium (4–12h for #16)      | [#16](https://github.com/djbclark/aiuse/issues/16) |
...
| [#15](https://github.com/djbclark/aiuse/issues/15)                                                    | Open · optional       | More shared-semantics fixtures (Cursor pools covered; Antigravity / OpenCode Go / multi-account Claude still open)     |
| [#16](https://github.com/djbclark/aiuse/issues/16)                                                    | Open · real           | DeepSeek 2nd prepaid-balance source (currently 1)                                                                      |
| [#17](https://github.com/djbclark/aiuse/issues/17)                                                    | **Closed 2026-08-11** | OpenRouter 2nd account-credit source (native collector added)                                                                     |
| [#18](https://github.com/djbclark/aiuse/issues/18)                                                    | **Closed 2026-08-02** | Groq confirmed 3 agreeing live sources on 2 independent runs (was 0 on 2026-07-30) — resolved upstream, no code needed |
...
| More shared-semantics fixtures | Cursor pools covered; Antigravity, OpenCode Go, multi-account Claude still open | Low                           | [#15](https://github.com/djbclark/aiuse/issues/15)                     |
