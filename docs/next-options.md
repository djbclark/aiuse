...
| **3**                | **Source expansion (real, unblocked, not optional polish)**  | DeepSeek/OpenRouter still have one live source each; Groq now has 3 (was 0 as of 2026-07-30) — re-verify before treating #18 as work | Medium (4–12h for #16/#17)      | [#16](https://github.com/djbclark/aiuse/issues/16), [#17](https://github.com/djbclark/aiuse/issues/17) — [#18](https://github.com/djbclark/aiuse/issues/18) likely already resolved |
...
| [#18](https://github.com/djbclark/aiuse/issues/18)                                                    | Open · likely resolved | Groq now has 3 agreeing live sources (2026-08-02 audit), was 0 on 2026-07-30 — re-verify, then likely close without implementing                                                                   |
